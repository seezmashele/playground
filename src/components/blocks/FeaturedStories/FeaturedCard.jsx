...
const FeaturedCard = ({ item }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -bottom-2 z-10 flex flex-col overflow-hidden px-4 pb-4 text-base font-semibold leading-snug text-white">
        <p className=" max-h-12 overflow-hidden">{cardTitle}</p>
        <div className="absoluteF bottom-0 flex hidden items-center text-sm">
          {/* <div className="card_author_image w-4 h-4 mr-2 overflow-hidden">
              <img src={authorImage} alt="" className="h-full w-full" />
            </div> */}
          <span className="inline_author pointer-events-none font-normal hover:no-underline">
            zelda
          </span>
        </div>
      </div>
