      ...
      <div className="flex w-full select-none space-x-10">
        <div className="relative inline-block w-1/2 flex-grow overflow-hidden">
          <div className="flex items-center text-sm">
            ...
            <span className="inline_author text-baseF mr-1 font-bold">
              itzJankMaster
            </span>
            <span className="inline_author text-neutral-500">
              @{cardAuthor}
            </span>
          </div>
          <Link href={cardLink} passHref>
            <div className="card_title mt-2 max-h-[5rem] overflow-hidden font-bold">
              {cardTitle}
            </div>
          </Link>
          <div className="mt-2.5 max-h-10 w-full max-w-xl overflow-hidden truncate text-sm leading-normal">
            {cardOverview}
          </div>
        ...
        <Link href={cardLink} passHref>
          <div className="image_bg box_radius hiddenF relative top-0 left-0 inline-block  h-36 w-56 cursor-pointer overflow-hidden">
            <img
              draggable="false"
