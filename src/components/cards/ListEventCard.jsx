...
const CategoryCard = ({ data, isLastItem = false }) => {
  ...
  return data.placeholder ? (
    ...
    <div className="card_container relative mb-5 w-full flex-grow overflow-hidden">
      <div className="flex w-full select-none space-x-10">
        <div className="relative inline-block w-1/2 flex-grow">
          ...
          <div className="mt-2.5 mb-3 flex flex-row items-center space-x-3">
            <div className="box_radius text-sm text-[#ff0000]">
              <Calendar2Event />
            </div>
            <div className=" font-semiboldF select-none text-xs">
              Mon, Jun 19, 2023
            </div>
          </div>
        ...
        <Link
          href={cardLink}
          passHref
          className="box_radius relative top-0 left-0 inline-block h-36 w-56 cursor-pointer overflow-hidden"
        >
          <div>
            <img
              draggable="false"
