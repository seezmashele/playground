...
const SidebarArticleCard = ({ item }) => {
  ...
  return (
    <Link href={itemLink} passHref>
      <div className="card_container box_radius relative mb-1 flex w-full flex-grow select-none flex-row overflow-hidden p-2 px-4 hover:bg-neutral-100">
        <div className="flex flex-col overflow-hidden">
          <div className="card_title max-h-11 cursor-pointer overflow-hidden text-sidebar_card_title font-semibold  hover:underline">
            {itemTitle}
          </div>
          <div className="mt-0.5 flex items-center text-sm">
            ...
            <span className="inline_author text-neutral-500">{cardAuthor}</span>
          </div>
        </div>
