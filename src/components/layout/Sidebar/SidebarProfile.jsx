...
const SidebarProfile = ({ item }) => {
  ...
  return (
    <div className="box_radius relative mb-0 flex w-full flex-grow cursor-pointer select-none flex-row items-center overflow-hidden py-2.5 px-5 hover:bg-neutral-100">
