...
const StudioDrawer = ({ selectedPageIndex = -1 }) => {
  ...
  return (
    <nav className="border_color--main stickyF border-rF rounded-tr-mdF border-rF fixed top-14 left-0  flex h-screen min-h-screen w-56 flex-shrink-0 flex-col pt-2.5 pl-3 pr-3">
      {/* <Link href="/" passHref>
