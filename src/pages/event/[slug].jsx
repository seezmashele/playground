...
import { GET_EVENT } from '../../utils/graphql/Queries'
      ...
      <div className="mx-auto ml-56 flex w-full max-w-5xl">
        ...
        <main className="page_width_wide page_padding_x mx-auto mt-0 w-full">
          <div className=" flex flex-row">
            <div className="main_content_container mt-16 pt-2">
                ...
                <div className="flex w-full select-none space-x-10">
                  <div className="relative inline-block w-1/2 flex-grow">
                    <div className="flex items-center text-sm">
                      <div className="card_author_image mr-2 h-12 w-12 overflow-hidden">
                        <img
                          src={authorImage}
                          alt=""
            ...
            {cardOverview}
                ...
                {/* <div className="border_color--main border-bF mt-5 w-full" /> */}
              </div>
